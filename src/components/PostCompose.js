...
//JSX part
  return (
    <div>
      <div className="border rounded-3 border-success p-3 shadow" style={{color: "#D7DF22"}}>
        <ToastContainer />
        <Form className="d-flex flex-column">
          <Form.Group className="mb-3">
            ...
            <Form.Control as="textarea" row={4} placeholder="What is happening?" value={postContent} onChange={handleContentChange} style={{ resize: "none", height: "7rem" }} />
          </Form.Group>
          <Form.Group className="mb-3">
          ...
          <div className="d-flex justify-content-end align-items-center">
            ...
            <Button onClick={handleCreatePost} variant="success" disabled={disablePostButton} className="col-2 mx-3" style={{backgroundColor: "#D7DF22"}}>
              Post
            </Button>
          </div>
        </Form>
